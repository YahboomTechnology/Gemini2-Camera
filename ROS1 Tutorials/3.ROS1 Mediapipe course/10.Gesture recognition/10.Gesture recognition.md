...
The potential recognition designed based on the right direction can accurately recognize when specific conditions are met. The recognizable gestures include: [Zero, One, Two, Three, Four, Five, Six, Seven, Eight, Okay, Rock, Thumb_up (like), Thumb_down (thumb down), Heart_single (single)], totaling 14 categories.
...
```
cd /home/yahboom/orbbec_ws/src/yahboomcar_mediapipe/scripts
python3 11_GestureRecognition.py
```

![image-20231016115537786](image-20231016115537786.png)

#### 2) Code

Code path: /home/yahboom/orbbec_ws/src/yahboomcar_mediapipe/scripts/11_GestureRecognition.py
