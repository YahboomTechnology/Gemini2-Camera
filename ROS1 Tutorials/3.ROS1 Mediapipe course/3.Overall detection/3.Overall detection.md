...
Combining the content of the first two sections, 1. Hand detection/2. Post detection, this routine implementation can detect both palm and human functions.
...
```
roscore
rosrun yahboom_mediapipe 03_Holistic.py
```

![image-20231016101640707](image-20231016101640707.png)

#### 2. Code

Code path: /home/yahboom/orbbec_ws/src/yahboomcar_mediapipe/scripts/03_Holistic.py
