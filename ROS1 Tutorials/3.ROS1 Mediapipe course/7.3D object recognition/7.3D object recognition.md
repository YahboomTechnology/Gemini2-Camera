...
3D object recognition: recognizable objects include: ['Shoe ',' Chair ',' Cup ',' Camera '], totaling 4 categories; Click the 'f' button to switch to recognizing objects.
...
![image-20231016105935750](image-20231016105935750.png)

#### 3. Code

Code path：/home/yahboom/orbbec_ws/src/yahboomcar_mediapipe/scripts/08_Objectron.py
